...
list_1 = [2, 4, -25, 9, 81, 144, -144, 625, 1024, 65537]
new_list = []
for x in list_1:
    if x > 0 and (math.sqrt(x) - int(math.sqrt(x)) == 0):
...
list_1 = date.split('.')
print('{} {} {} г.'.format(day[list_1[0]], month[list_1[1]], list_1[2]).capitalize())
...
x = int(input('Введите желаемое количество случайных чисел: '))
magic_list = []
for y in range(x):
    magic_list.append(random.randint(-100, 100))
print(magic_list)
...
list_1 = [12, 12, -3, 4, 5, 6, 7, 77, 7, 12, 78, 87, 88, -12]
list_2 = set(list_1)
print(list_2)
